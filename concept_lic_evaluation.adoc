...
[NOTE]
====
若要下載 ONTAP Select Deploy 管理公用程式，您需要下列項目： * 註冊的 NetApp 支援網站帳戶。如果您沒有帳戶，請參閱 https://mysupport.netapp.com/site/user/registration["使用者登錄"^]。* 轉至 https://mysupport.netapp.com/site/downloads/evaluation/ontap-select["接受終端使用者授權合約"^]，適用於具有評估授權的 ONTAP Select 部署。
