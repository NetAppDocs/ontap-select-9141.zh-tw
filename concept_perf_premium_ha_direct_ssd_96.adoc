...
| 採用DAS（SSD）軟體RAID的大型執行個體ONTAP Select | 2171億次 | 559 MiBps | 954 MiBps | 394-393MBps | 564 MBps 


| 採用DAS（SSD）軟體RAID的中型執行個體ONTAP Select | 2090億美元 | 592 次 MiBps | 677 MiBps | 335 個 MiBps | 441 3億次 


| 採用DAS（SSD）硬體RAID的中型執行個體ONTAP Select | 2038 MiBps | 520億分之一 | 578台MiBps | 325迷你吧 | 399 MiBps 
|===
